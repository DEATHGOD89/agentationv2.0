...
// Framework scanners (for building custom UIs)
export {
  initScanners,
  scanElement,
...
export type { FrameworkScanner, FrameworkInfo, FrameworkType } from "./scanners";

// Context collectors (network, console, state)
export {
  startCollectors,
  stopCollectors,
  snapshotCollectors,
...
export type { Collector, CollectorSnapshot, NetworkRequest, ConsoleEntry, StateSnapshot } from "./collectors";
