...
// ---------------------------------------------------------------------------
export function initFreezePatches(): void {
...
// ---------------------------------------------------------------------------
export const originalSetTimeout = (handler: TimerHandler, timeout?: number, ...args: any[]) => _s.origSetTimeout(handler, timeout, ...args);
export const originalSetInterval = (handler: TimerHandler, timeout?: number, ...args: any[]) => _s.origSetInterval(handler, timeout, ...args);
export const originalRequestAnimationFrame = (callback: FrameRequestCallback) => _s.origRAF(callback);
