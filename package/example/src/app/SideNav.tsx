...
function WordmarkLogo({ isOverview }: { isOverview: boolean }) {
  return (
    <div className="side-nav-logo">
      ...
      >
        <img src="/megamorph.png" alt="Megamorph Logo" width={32} height={32} style={{ borderRadius: '6px' }} />
        <span style={{ fontSize: '1.75rem', fontWeight: 700, fontFamily: '"Caveat", cursive', color: '#E5484D', letterSpacing: '0.02em', marginTop: '4px' }}>Megamorph</span>
      </Link>
    </div>
  );
}
