  ...
  return (
    <>
      <article className="article" style={{ paddingTop: '3.75rem' }}>
        <header>
          <div className="heading-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '1rem' }}>
            <img src="/megamorph.png" alt="Megamorph Logo" width="100" style={{ borderRadius: '8px' }} />
            <h1 style={{ fontSize: "2rem", lineHeight: 1.15, marginBottom: "0.5rem" }}>
              <span className="sketchy-underline">Agentation Megamorph.</span><br />
              Not the old version.
            </h1>
            <InstallSnippet />
          </div>
          <p className="tagline">Agentation Megamorph is the upgraded version that supports EVERYTHING! It fully supports React, Vue, Svelte, Angular, Solid, Redux, Zustand, Vuex, and captures full Network and Console logs. Click any element, add a note, and see the forensic output.</p>
        </header>
